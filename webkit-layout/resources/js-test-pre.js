...
(function() {
	...
	span.style.textIndent ="200px";
	span.style.padding = "50px 10px 20px 30px";
        if (quiet)
...
function testPassed(msg)
{
	...
	console.log("PASS  " + escapeHTMLAndStripFileURLs(msg));
    }
}
...
function testFailed(msg)
{
    ...
    console.log("FAIL  " + escapeHTMLAndStripFileURLs(msg));
}
